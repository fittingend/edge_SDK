...
#ifndef __EDGE_INFORMATION_SUBSCRIBER_H__
#define __EDGE_INFORMATION_SUBSCRIBER_H__
 ...
 */
class EdgeInformation_Subscriber
{
    using Proxy = adcm::proxy::edge_informationProxy;

public:
    EdgeInformation_Subscriber();
    ...
    std::shared_ptr<edge_information_Objects> getEvent();
     ...
     */
    void receivedCallback_edgeInformation();
...
protected:
    ...
    std::queue<std::shared_ptr<edge_information_Objects>> m_Queue_event;
    std::shared_ptr<ara::core::Promise<bool>> m_promise_waitEvent;

    void enQueue(std::shared_ptr<edge_information_Objects> item);
    std::shared_ptr<edge_information_Objects> deQueue();
     ...
     */
    void subscribe_edgeInformation();
};

}  // namespace adcm

#endif  // __EDGE_INFORMATION_SUBSCRIBER_H__
