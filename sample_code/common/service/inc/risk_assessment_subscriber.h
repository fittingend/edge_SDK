...
#ifndef __RISK_ASSESSMENT_SUBSCRIBER_H__
#define __RISK_ASSESSMENT_SUBSCRIBER_H__
 ...
 */
class RiskAssessment_Subscriber
{
    using Proxy = adcm::proxy::risk_assessmentProxy;

public:
    RiskAssessment_Subscriber();
    ...
    std::shared_ptr<risk_assessment_Objects> getEvent();
     ...
     */
    void receivedCallback_riskAssessment();
...
protected:
    ...
    std::queue<std::shared_ptr<risk_assessment_Objects>> m_Queue_event;
    std::shared_ptr<ara::core::Promise<bool>> m_promise_waitEvent;

    void enQueue(std::shared_ptr<risk_assessment_Objects> item);
    std::shared_ptr<risk_assessment_Objects> deQueue();
     ...
     */
    void subscribe_riskAssessment();
};

}  // namespace adcm

#endif  // __RISK_ASSESSMENT_SUBSCRIBER_H__
