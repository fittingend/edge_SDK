...
#ifndef __BUILD_PATH_SUBSCRIBER_H__
#define __BUILD_PATH_SUBSCRIBER_H__
 ...
 */
class BuildPath_Subscriber
{
    using Proxy = adcm::proxy::build_pathProxy;

public:
    BuildPath_Subscriber();
    ...
    bool popEvent(std::shared_ptr<build_path_Objects>& event);
     ...
     */
    void receivedCallback_buildPath();
...
protected:
    ...
    std::queue<std::shared_ptr<build_path_Objects>> m_Queue_event;
...
#endif  // __BUILD_PATH_SUBSCRIBER_H__