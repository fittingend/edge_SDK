...
void ThreadReceiveMapData()
{
    ...
    while (continueExecution)
    {
        ...
        if (mapData_rxEvent)
        {
            ...
            std::shared_ptr<adcm::map_data_Objects> data;
            while (mapData_subscriber.popEvent(data))
            {
...
void ThreadReceiveBuildPathTest()
{
    ...
    while (continueExecution)
    {
        ...
        if (buildPathTest_rxEvent)
        {
            ...
            std::shared_ptr<adcm::build_path_test_Objects> data;
            while (buildPathTest_subscriber.popEvent(data))
            {
...
void ThreadReceiveBuildPath()
{
    ...
    while (continueExecution)
    {
        ...
        if (buildPath_rxEvent)
        {
            ...
            std::shared_ptr<adcm::build_path_Objects> data;
            while (buildPath_subscriber.popEvent(data))
            {
